...
public interface SysLogsDao {
	...
	@Insert("insert into mutest.sys_logs(userId, module, flag, remark, createTime) values(#{user.id}, #{module}, #{flag}, #{remark}, now())")
	...
	@Delete("delete from mutest.sys_logs where createTime <= #{time}")
