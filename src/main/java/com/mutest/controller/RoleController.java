...
import com.mutest.dao.base.RoleDao;
...
import com.mutest.service.RoleService;
...
public class RoleController {
    ...
    @RequestMapping(value = "/roleNicknameList", method = RequestMethod.GET)
    public List<String> getRoleNicknameList() {
        return roleDao.getRoleNickNameList();
    }
}
