...
layui.use(['form', 'jquery', "layer"], function () {
    ...
    $(".changePassword").click(function () {
        index = layer.open({
            ...
            area: ["527px", "282px"],
            type: "1",
            content: '<div class="layui-col-md11">' +
                '<form id="add_form" class="layui-form" action="" style="margin-top: 20px;align:center;">' +
                '<div class="layui-form-item">' +
                '<label class="layui-form-label">原密码</label>' +
                '<div class="layui-input-block">' +
                '<input type="password" name="passwordOld" placeholder="请输入原密码" autocomplete="off" lay-verify="required" class="layui-input">' +
                '</div>' +
                '</div>' +
                ...
                '<div class="layui-input-block">' +
                '<input type="password" name="passwordNew" placeholder="请输入新密码" autocomplete="off" lay-verify="required" class="layui-input">' +
                '</div> ' +
                '</div>' +
                '<div class="layui-form-item">' +
                '<label class="layui-form-label">确认密码</label>' +
                '<div class="layui-input-block">' +
                '<input type="password" name="passwordConfirm" placeholder="请再次输入新密码" autocomplete="off" lay-verify="required" class="layui-input">' +
                '</div>' +
                '</div>' +

                '<div class="layui-form-item" style="margin-left: 40%">' +
                '<div class="layui-btn-group">' +
                '<button class="layui-btn" lay-submit="" lay-filter="password_submit">提&ensp;交</button>' +
