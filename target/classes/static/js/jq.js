...
function buttonDel(data, permission, pers) {
    ...
    // 修改样式  2020/4/29
    var btn = $("<button class='layui-btn layui-btn-xs layui-btn-danger' title='删除' onclick='del(\"" + data + "\")'>删除</button>");
...
function buttonEdit(href, permission, pers) {
    ...
    // 修改样式  2020/4/29
    var btn = $("<button class='layui-btn layui-btn-xs' title='编辑' onclick='window.location=\"" + href + "\"'>编辑</button>");
